...
@section('mainContent')
    <div class="intro-page d-flex align-items-center">
        <div class="page-intro__cover jarallax"><img class="img-cover" src="{{ asset('images/upload/16.jpg') }}" alt="#"/></div>
    ...
    <div class="bg-white display-none">
        <nav class="breadcrumb-nav d-flex align-items-center" aria-label="breadcrumb">
            <div class="container">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="under" href="index-2.html">Home</a></li>
    ...
    <div class="page-content">
        <div class="container">
            <div class="col-12 col-lg-6 float-lg-left px-0 pr-lg-4 mb-3"><a href="/contact-us"><img class="img-fluid mx-auto" src="{{ asset('images/upload/14.jpg') }}" alt="#"></a></div>
            ...
            <p class="text-right"><a class="btn btn-btn btn-dark" href="/contact-us" role="button">Our contacts</a>
            </p>
        </div>
